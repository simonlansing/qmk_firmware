...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [FUNCTIONS] = LAYOUT(
        _______, KC_WIN,  KC_GMNG, KC_MAC,  KC_LINX, _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_PSCR,          _______,
        _______, KC_SEC1, KC_SEC2, KC_SEC3, KC_SEC4, KC_SEC5, _______, _______, _______, _______, _______, _______, _______,  KC_RST,           KC_INS,
        _______, KC_RGBH, KC_RGBS, KC_RGBV, KC_RGBE, KC_RGBP, KC_WRGB, _______, _______, _______, _______, _______, _______,                   _______,
...
//      LU_8                                                                                                                                          RU_8
    ...
    [GAMING] = RGB_MATRIX_LAYOUT_LEDMAP(
        PURPLE,                                                                                                                                       PURPLE,
        PURPLE,    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,         ______,    PURPLE,
        PURPLE,    ______, YELLOW, YELLOW, YELLOW, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,         ______,    PURPLE,
        PURPLE,    ______,   BLUE,    RED,   BLUE, ______, ______, ______, ______, ______, ______, ______, ______, ______,                 ______,    PURPLE,
        PURPLE,    ______,    RED,    RED,    RED,   BLUE, YELLOW, ______, ______, ______, ______, ______, ______, ______, ______,         ______,    PURPLE,
        PURPLE,       RED, ______, ______, ______,    RED, ______, ______, ______, ______, ______, ______, ______,         ______, ______, ______,    PURPLE,
        PURPLE,    ______, ______,   BLUE,                            RED,                         ______, ______, ______, ______, ______, ______,    PURPLE,
        PURPLE,                                                                                                                                       PURPLE
    ),
    ...
    [LINUX] = RGB_MATRIX_LAYOUT_LEDMAP(
        ...
        ORANGE,    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,         ______,    ORANGE,
        ORANGE,    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,         ______, ______, ______,    ORANGE,
        ORANGE,    ______,    RED, ______,                         ______,                         ______, ______, ______, ______, ______, ______,    ORANGE,
        ORANGE,                                                                                                                                       ORANGE
    ),
